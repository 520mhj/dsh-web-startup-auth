...
;(async function () {
  ...
  // Retroactively wrap routes + hijack register — ONLY for 0.0.0.0 direct
  // exposure. In reverse-proxy mode (127.0.0.1) the proxy handles auth and
  // Host rewriting; wrapping handlers breaks DSH's static file server (HTTP 400).
